export const es = {
  ...
  'trust.point1.explanation':
    'Postulate nació de nuestra propia frustración al buscar empleo. Sabemos lo abrumador que puede ser y por eso creamos la herramienta que siempre quisimos tener.',
  ...
  'landing.benefits.withPostulate.title': 'Con Postulate',
  'landing.benefits.withPostulate.subtitle': 'Optimiza tu búsqueda de empleo',
  'landing.benefits.withPostulate.title1': 'Seguimiento eficiente',
  'landing.benefits.withPostulate.subtitle1': 'Lleva el control de todas tus postulaciones',
  'landing.benefits.withPostulate.title2': 'Organización total',
  'landing.benefits.withPostulate.subtitle2': 'Centraliza tu información laboral',
  'landing.benefits.withPostulate.title3': 'Búsqueda rápida',
  'landing.benefits.withPostulate.subtitle3': 'Encuentra oportunidades fácilmente',
  'landing.benefits.withPostulate.effectiveness': 'Efectividad',
  'landing.benefits.withoutPostulate.title': 'Sin Postulate',
  'landing.benefits.withoutPostulate.subtitle': 'Desorden y pérdida de oportunidades',
  'landing.benefits.withoutPostulate.title1': 'Desorganización',
  'landing.benefits.withoutPostulate.subtitle1': 'Difícil seguimiento de postulaciones',
  'landing.benefits.withoutPostulate.title2': 'Información dispersa',
  'landing.benefits.withoutPostulate.subtitle2': 'Datos en múltiples plataformas',
