        ...
        >
          <div className="flex gap-4 md:gap-8 transition-all duration-500 ease-in-out justify-center items-center w-full">
            {visibleCards.map((feature, pos) => {
              const base = "transition-all duration-500 flex flex-col items-center justify-center text-center min-w-0"
              ...
              const sizeStyle = isCenter
                ? {
                    width: isMobile ? '90vw' : cardWidth,
                    minWidth: isMobile ? '90vw' : cardWidth,
