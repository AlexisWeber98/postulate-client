export const heroTexts = {
  ...
  en: {
    ...
    'landing.intro.card1': 'Job searching will no longer be just another job',
    'landing.intro.card2': 'Organize your search, find your opportunity',
    'landing.intro.card3': 'Total control of your applications',
