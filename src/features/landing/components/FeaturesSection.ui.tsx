...
const FeaturesSection: React.FC<FeaturesSectionProps> = ({ t }) => (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    <div className="border border-blue-200 shadow-2xl rounded-3xl bg-gradient-to-r from-blue-500 to-violet-500 text-white p-8 transition-transform hover:-translate-y-1 flex flex-col items-center text-center">
      ...
      <h3 className="text-lg md:text-xl font-semibold text-white mb-2">{t('card1.title')}</h3>
    ...
    <div className="border border-blue-200 shadow-2xl rounded-3xl bg-gradient-to-r from-blue-500 to-violet-500 text-white p-8 transition-transform hover:-translate-y-1 flex flex-col items-center text-center">
      ...
      <h3 className="text-lg md:text-xl font-semibold text-white mb-2">{t('card2.title')}</h3>
      <p className="text-white/90 text-base md:text-base">
        {t('card2.desc')}
      </p>
    </div>
    ...
    <div className="border border-blue-200 shadow-2xl rounded-3xl bg-gradient-to-r from-blue-500 to-violet-500 text-white p-8 transition-transform hover:-translate-y-1 flex flex-col items-center text-center">
      ...
      <h3 className="text-lg md:text-xl font-semibold text-white mb-2">{t('card3.title')}</h3>
      <p className="text-white/90 text-base md:text-base">
        {t('card3.desc')}
      </p>
    </div>
