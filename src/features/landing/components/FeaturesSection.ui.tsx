  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="border border-blue-200 shadow-2xl rounded-3xl bg-gradient-to-r from-blue-500 to-violet-500 text-white p-8 transition-transform hover:-translate-y-1 flex flex-col items-center text-center relative hover:z-20">
        ...
        <p className="text-white/90 text-base md:text-base">{translate('card1.desc')}</p>
      </div>
      ...
      <div className="border border-blue-200 shadow-2xl rounded-3xl bg-gradient-to-r from-blue-500 to-violet-500 text-white p-8 transition-transform hover:-translate-y-1 flex flex-col items-center text-center relative hover:z-20">
        ...
        <p className="text-white/90 text-base md:text-base">{translate('card2.desc')}</p>
      </div>
      ...
      <div className="border border-blue-200 shadow-2xl rounded-3xl bg-gradient-to-r from-blue-500 to-violet-500 text-white p-8 transition-transform hover:-translate-y-1 flex flex-col items-center text-center relative hover:z-20">
        ...
        <p className="text-white/90 text-base md:text-base">{translate('card3.desc')}</p>
      </div>
    </div>
  );
};
