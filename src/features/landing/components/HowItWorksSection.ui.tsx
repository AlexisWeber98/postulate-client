  ...
  return (
    <div className="text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {steps.map((step, idx) => (
          <Box key={idx} className="shadow-2xl rounded-3xl bg-gradient-to-r from-blue-600 to-violet-600 text-white p-0 flex flex-col items-center text-center transition-transform hover:-translate-y-1">
            <Card size="2" style={{ background: 'transparent', boxShadow: 'none', width: '100%' }}>
              <div className="relative">
                <Inset clip="padding-box" side="top" pb="current">
                  ...
                  />
                  <div
                    className="absolute left-1/2 -translate-x-1/2 -top-6 w-16 h-16 flex items-center justify-center rounded-full bg-white/30 shadow-lg z-10 backdrop-blur"
