    ...
    <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-2 md:gap-2 text-center md:text-left relative z-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start">
        ...
        >
          <Link
            to="/login"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl shadow-xl text-white font-extrabold text-lg transition bg-gradient-to-r from-blue-500 to-violet-500 hover:from-blue-600 hover:to-violet-600 focus:outline-none focus:ring-2 focus:ring-blue-400 w-[200px] whitespace-nowrap"
          >
            {t('login')}
          </Link>
          <Link
            to="/register"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl shadow-xl text-blue-700 font-extrabold text-lg transition bg-white border border-blue-300 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-400 w-[200px] whitespace-nowrap"
          >
            {t('register')}
          </Link>
        </motion.div>
