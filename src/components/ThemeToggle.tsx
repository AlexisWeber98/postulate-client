...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      {/* Luna */}
      <Moon
        className={`w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 transition-colors ${
          theme === 'dark' ? 'text-yellow-200' : 'text-gray-500'
        }`}
      />
      {/* Sol */}
      <Sun
        className={`w-4 h-4 absolute right-2 top-1/2 -translate-y-1/2 transition-colors drop-shadow-[0_4px_12px_rgba(255,193,7,0.95)] ${
