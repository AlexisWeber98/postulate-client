...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      ghost:
        'bg-transparent text-gray-500 hover:bg-gray-100 hover:text-gray-700 focus:ring-blue-500',
      gradient:
        'bg-gradient-to-r from-blue-500 to-violet-500 text-white hover:from-blue-600 hover:to-violet-600 focus:ring-blue-400 shadow-xl',
    };
      ...
      >
        {
          ...
          ) /* Considerar un spinner SVG/mejorado */
        }
