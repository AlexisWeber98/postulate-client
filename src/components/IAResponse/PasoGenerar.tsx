...
const PasoGenerar: React.FC<PasoGenerarProps> = ({
  translate,
  respuesta,
  setRespuesta,
  setLoading,
  ...
  <>
    ...
    <div className="w-full max-w-4xl mx-auto bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow p-6 mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      <div className="flex items-center gap-3">
        ...
        <span className="text-2xl font-extrabold text-gray-900 dark:text-white">
          {translate('ia.generated')}
        </span>
        <span className="ml-2 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full px-3 py-1">
          {translate('ia.status.ready')}
        </span>
      </div>
    ...
    <div className="w-full max-w-4xl mx-auto bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 mb-8">
      <pre
        className="whitespace-pre-wrap break-words text-gray-900 dark:text-white text-base font-sans"
