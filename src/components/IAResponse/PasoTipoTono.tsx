...
const PasoTipoTono: React.FC<PasoTipoTonoProps> = ({
  translate,
  tipoRespuesta,
  setTipoRespuesta,
  tono,
  ...
  <>
    <div className="w-full max-w-4xl mx-auto bg-gradient-to-r from-blue-500 to-violet-500 rounded-2xl shadow-2xl p-6 mb-8 flex flex-col gap-2">
      <div className="flex items-center gap-3 mb-1">
        <span className="bg-blue-400 bg-opacity-30 text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-2xl">
          2
        </span>
    ...
    <div className="w-full max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6">
        <div className="font-semibold text-gray-800 dark:text-gray-100 mb-4">
          {translate('ia.responseType')}
        </div>
        <div className="space-y-3">
          <label className="flex items-center gap-3 cursor-pointer p-3 rounded-xl border dark:border-gray-700 transition hover:bg-gray-50 dark:hover:bg-gray-800">
            <input
              ...
              name="tipoRespuesta"
              value="carta"
              checked={tipoRespuesta === 'carta'}
              onChange={() => setTipoRespuesta('carta')}
              className="accent-blue-500 w-5 h-5"
            />
            <span className="text-gray-800 dark:text-gray-100 font-medium flex items-center gap-2">
              <span role="img" aria-label="carta">
                📄
              </span>{' '}
              {translate('ia.type.letter')}
            </span>
          </label>
          <label className="flex items-center gap-3 cursor-pointer p-3 rounded-xl border dark:border-gray-700 transition hover:bg-gray-50 dark:hover:bg-gray-800">
            <input
              ...
              name="tipoRespuesta"
              value="email"
              checked={tipoRespuesta === 'email'}
              onChange={() => setTipoRespuesta('email')}
              className="accent-blue-500 w-5 h-5"
            />
            <span className="text-gray-800 dark:text-gray-100 font-medium flex items-center gap-2">
          ...
          <label className="flex items-center gap-3 cursor-pointer p-3 rounded-xl border dark:border-gray-700 transition hover:bg-gray-50 dark:hover:bg-gray-800">
            <input
              ...
              name="tipoRespuesta"
              value="cv"
              checked={tipoRespuesta === 'cv'}
              onChange={() => setTipoRespuesta('cv')}
              className="accent-blue-500 w-5 h-5"
            />
            <span className="text-gray-800 dark:text-gray-100 font-medium flex items-center gap-2">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6">
        ...
        <div className="relative">
          <select
            ...
            className="w-full rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-3 text-base font-normal text-gray-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition font-sans bg-white dark:bg-gray-900"
          >
