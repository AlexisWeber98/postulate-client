...
const TabsGradient = <T extends string>({
  tabs,
  activeTab,
  onTabChange,
  className = '',
  ...
  return (
    <div
      className={`flex w-full rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-white/60 dark:bg-gray-800/60 shadow-lg ${className}`}
    >
      {tabs.map(tab => (
        <button
          key={tab.value}
