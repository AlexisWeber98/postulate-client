      ...
      <StyledModalContainer>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-white/10 rounded-xl p-4 text-center">
            <div className="text-white/60 text-sm mb-1">{t('dashboard.company')}</div>
            <div className="text-white font-semibold">{company}</div>
          </div>
          <div className="bg-white/10 rounded-xl p-4 text-center">
            <div className="text-white/60 text-sm mb-1">{t('dashboard.date')}</div>
        ...
        {notes && (
          <div className="mb-6">
            <h3 className="text-white/60 text-sm mb-2">{t('dashboard.notes')}</h3>
        ...
        {url && (
          <div className="mb-6">
            <h3 className="text-white/60 text-sm mb-2">{t('dashboard.url')}</h3>
            <a
              href={url}
              target="_blank"
        ...
        <div className="text-white/40 text-xs flex justify-between mb-6">
          <span>{t('dashboard.created')}: {new Date(createdAt).toLocaleDateString()}</span>
          <span>{t('dashboard.updated')}: {new Date(updatedAt).toLocaleDateString()}</span>
        </div>
