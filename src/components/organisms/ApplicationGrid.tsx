      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center mt-8 gap-2">
          <button
            ...
            aria-label={translate('pagination.previousPage') || "Previous Page"}
          >
          ...
          {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
            <button
              ...
              aria-label={`${translate('pagination.goToPage') || "Go to page"} ${page}`}
          ...
          <button
            ...
            className="p-2 rounded-lg bg-white/30 dark:bg-gray-800/30 hover:bg-white/50 dark:hover:bg-gray-700/50 disabled:opacity-50 disabled:cursor-not-allowed"
            aria-label={translate('pagination.nextPage') || "Next Page"}
          >
